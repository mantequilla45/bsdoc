          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="/medication-guide" className="text-white/80 hover:text-white hover:pl-2 transition-all duration-300 block">
                    OTC Medications
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/doctor-profiles" className="text-white/80 hover:text-white hover:pl-2 transition-all duration-300 block">
                    Find Doctors
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/faqs" className="text-white/80 hover:text-white hover:pl-2 transition-all duration-300 block">
                    FAQs
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/terms-conditions" className="text-white/80 hover:text-white hover:pl-2 transition-all duration-300 block">
                    Terms & Conditions
                  </a>
                </li>
                <li>
