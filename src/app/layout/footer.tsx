    ...
    <footer className="bg-gradient-to-b from-[#018487] to-[#014C4E] py-8 md:py-16 flex flex-col">
      <div className="w-full max-w-[1300px] mx-auto px-4 sm:px-6 md:px-16">
        ...
        <div className="font-semibold text-black my-8 md:my-16 flex justify-center md:justify-start">
          <a className="py-3 md:py-5 px-6 sm:px-8 md:px-16 lg:px-[100px] rounded-xl bg-[#ED5050] text-white text-sm md:text-base hover:bg-[#d64646] transition-colors duration-200 cursor-pointer active:scale-95">
            BOOK
          </a>
        </div>
